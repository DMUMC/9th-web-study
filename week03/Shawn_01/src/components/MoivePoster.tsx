...
export const MoivePoster = ({ movie }: { movie: MovieT }) => {
    return (
        <div className='rounded-xl w-48 h-72'>
            <div className='relative group hover:scale-105 transition-all duration-300 drop-shadow-xl'>
                <img className='w-full h-full object-cover rounded-xl group-hover:blur-sm transition-all duration-300' src={`https://image.tmdb.org/t/p/w500${movie.poster_path}`} alt={movie.title} />
