...
export const FloatingButton = () => {
    return (
        <div>
            <Link to="/create" className="fixed bottom-12 right-12 bg-teal-500 text-white rounded-full p-2 hover:bg-teal-600 transition w-14 h-14 flex items-center justify-center z-100">
