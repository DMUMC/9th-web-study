        ...
        {step === 1 && (
          <>
            <input 
              {...register('email')}
              type={'email'} 
              className={`border border-white bg-[#202020] w-full p-3 focus:outline-none focus:border-[#ff00b3] rounded-lg text-sm text-white placeholder-gray-400
          ...
          <>
            ...
            <div className="relative w-full">
              <input 
                ...
                className={`border border-white bg-[#202020] w-full p-3 mt-2 focus:outline-none focus:border-[#ff00b3] rounded-lg text-sm text-white placeholder-gray-400
