            ...
            case 2:
                return <div className='flex flex-col gap-6'>
                    ...
                    <div className='flex items-center gap-2'>
                        <img src={mail} alt="mailIcon" className='w-6 h-6'/>
                        <p>{getValues('email')}</p>
                    </div>
                    <div>
                        <div className='w-full rounded-md border border-gray-300 focus-within:border-teal-500 focus-within:ring-2 focus-within:ring-teal-500 flex items-center justify-between px-4'>
                            ...
                            {...register('password')}
                            />
                            <img src={showPass ? eye : eyeoff} alt="eye" className='w-6 h-6' onClick={() => setShowPass(!showPass)} />
                        </div>
                    ...
                    <div>
                        <div className='w-full rounded-md border border-gray-300 focus-within:border-teal-500 focus-within:ring-2 focus-within:ring-teal-500 flex items-center justify-between px-4'>
                            ...
                            />
                            <img src={showPassCheck ? eye : eyeoff} alt="eye" className='w-6 h-6' onClick={() => setShowPassCheck(!showPassCheck)} />
                        </div>
