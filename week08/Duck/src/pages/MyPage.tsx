...
const MyPage = () => {
  const { data, isLoading, isError, refetch } = useGetMyInfo();
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-pink-500 to-purple-600 px-8 py-12">
          <div className="flex flex-col items-center gap-6 md:flex-row md:items-end">
            ...
            <div className="flex-1 text-center text-white md:text-left">
              ...
              {user.bio && <p className="mt-3 text-white/80">{user.bio}</p>}
            </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="rounded-xl bg-gradient-to-br from-pink-50 to-pink-100 p-6 shadow">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-pink-600">내 LP 수</p>
        ...
        <div className="rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 p-6 shadow">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-blue-600">작성한 댓글</p>
      ...
      <div className="rounded-xl bg-white p-6 shadow-lg">
        <h3 className="mb-4 text-xl font-semibold text-gray-900">빠른 액션</h3>
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">새로운 LP를 등록하세요</p>
            </div>
          </button>
